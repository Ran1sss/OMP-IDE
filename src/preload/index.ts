...
const api: IdeApi = {
  ...
  git: {
    ...
    setIdentity: (root, name, email) => ipcRenderer.invoke("git:setIdentity", root, name, email),
  ...
  omp: {
    ...
    listSessions: (root) => ipcRenderer.invoke("omp:listSessions", root),
    readSession: (file) => ipcRenderer.invoke("omp:readSession", file),
    onStatus: (cb) => on<[OmpStatus]>("omp:status", cb),
    onEvent: (cb) => on<[OmpEvent]>("omp:event", cb),
    onUiRequest: (cb) => on<[OmpUiRequest]>("omp:uiRequest", cb),
  },
  team: {
    getState: (): Promise<TeamRunState | null> => ipcRenderer.invoke("team:getState"),
    roster: () => ipcRenderer.invoke("team:roster"),
    start: (goal, mentions) => ipcRenderer.invoke("team:start", goal, mentions),
    steer: (text, target) => ipcRenderer.invoke("team:steer", text, target),
    approve: () => ipcRenderer.invoke("team:approve"),
    hold: () => ipcRenderer.invoke("team:hold"),
    discard: () => ipcRenderer.invoke("team:discard"),
    stop: () => ipcRenderer.invoke("team:stop"),
    editSlice: (id, patch) => ipcRenderer.invoke("team:editSlice", id, patch),
    addSlice: (input) => ipcRenderer.invoke("team:addSlice", input),
    deleteSlice: (id) => ipcRenderer.invoke("team:deleteSlice", id),
    setDeps: (id, deps) => ipcRenderer.invoke("team:setDeps", id, deps),
    needsCall: (choice, editedScope) => ipcRenderer.invoke("team:needsCall", choice, editedScope),
  ...
  models: {
    ...
    enhance: (draft, origin) => ipcRenderer.invoke("models:enhance", draft, origin),
    enhanceStatus: () => ipcRenderer.invoke("models:enhanceStatus"),
