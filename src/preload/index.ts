...
const api: IdeApi = {
  ...
  models: {
    ...
    checkAllBalances: () => ipcRenderer.invoke("models:checkAllBalances"),
    setLowThreshold: (id, threshold) => ipcRenderer.invoke("models:setLowThreshold", id, threshold),
    setAutoSwap: (enabled) => ipcRenderer.invoke("models:setAutoSwap", enabled),
    setRoleSwapOptOut: (role, optOut) => ipcRenderer.invoke("models:setRoleSwapOptOut", role, optOut),
    setBalancePollMinutes: (minutes) => ipcRenderer.invoke("models:setBalancePollMinutes", minutes),
    clearDepleted: (id) => ipcRenderer.invoke("models:clearDepleted", id),
    ...
    onSwapNotice: (cb) => on<[{ message: string; crit: boolean }]>("models:swapNotice", cb),
  },
};
